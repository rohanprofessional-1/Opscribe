...
const SignUpPage: React.FC<SignUpPageProps> = ({ onSignUp, onBackToLanding, onGoToLogin }) => {
      ...
      <div className="w-full max-w-lg">
        <div className="glass-card p-10 border-white/10 bg-white/[0.02] rounded-[2.5rem] shadow-2xl relative overflow-hidden text-center">
          ...
          <div className="w-16 h-16 rounded-2xl mx-auto mb-6 overflow-hidden flex items-center justify-center bg-white/5 border border-white/10">
            ...
            <h1 className="text-4xl font-black tracking-tighter mb-3 uppercase">Join Opscribe</h1>
            <p className="text-slate-400 font-medium">Start mapping your infrastructure in minutes.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-3 p-4 bg-blue-500/5 border border-blue-500/10 rounded-2xl">
              ...
              <p className="text-[10px] text-slate-400 leading-relaxed uppercase font-black tracking-wider">
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full bg-indigo-600 text-white font-black py-4 rounded-2xl hover:bg-indigo-500 transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-xl shadow-indigo-600/20 disabled:opacity-50"
            >
              {isLoading ? (
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-xs uppercase font-black tracking-widest">
              <span className="bg-[#0b101f] px-4 text-slate-500">Or join with</span>
            </div>
          </div>
